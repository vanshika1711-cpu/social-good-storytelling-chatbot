      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-social-blue-600 to-social-green-600 bg-clip-text text-transparent">
              {" "}
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
            Share your community needs, and let AI craft inspiring stories,
        ...
        <div className="mt-24 grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center p-8 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
            ...
            <p className="text-gray-600">
              Simply tell us about the challenges your community faces. Our AI
              understands local issues and amplifies your voice.
            </p>
          </div>
          ...
          <div className="text-center p-8 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
            ...
            <p className="text-gray-600">
              Our advanced AI transforms your input into compelling narratives
              that inspire action and drive social change.
            </p>
          </div>
          ...
          <div className="text-center p-8 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20">
            ...
            <p className="text-gray-600">
              Get blog posts, flyers, and social media content ready for
              immediate use. Download PDFs or share links instantly.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm">
                Click the button above and begin describing your community's
                story
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm">
                Watch as our AI generates compelling stories and calls to action
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm">
                Download or share your content to make a real difference
              </p>
            </div>
          </div>
        </div>
